...
DELETE FROM rate_limits; ALTER TABLE rate_limits AUTO_INCREMENT = 1;
DELETE FROM banners; ALTER TABLE banners AUTO_INCREMENT = 1;
DELETE FROM operating_hours; ALTER TABLE operating_hours AUTO_INCREMENT = 1;
DELETE FROM settings; ALTER TABLE settings AUTO_INCREMENT = 1;
DELETE FROM reviews; ALTER TABLE reviews AUTO_INCREMENT = 1;
...
DELETE FROM cart_items; ALTER TABLE cart_items AUTO_INCREMENT = 1;
DELETE FROM carts; ALTER TABLE carts AUTO_INCREMENT = 1;
DELETE FROM menus; ALTER TABLE menus AUTO_INCREMENT = 1;
DELETE FROM sauces; ALTER TABLE sauces AUTO_INCREMENT = 1;
...
(17, 4, 'French Fries', 'french-fries', 'Kentang goreng renyah disajikan dengan saus Spicy & Mayo.', 12000, 'img/Menu/French Fries.png', 1, 40),
...
(19, 4, 'Egg (Telur)', 'egg-telur', 'Tambahan telur ceplok atau dadar untuk pelengkap hidanganmu.', 5000, 'img/Menu/Egg.png', 1, 100),
(20, 5, 'Es Teh Manis', 'es-teh-manis', 'Teh manis dingin segar alami.', 5000, 'img/Menu/Es Teh Manis.png', 1, 100),
(21, 5, 'Lemon Tea', 'lemon-tea', 'Teh lemon dingin yang segar dan kaya vitamin C.', 8000, 'img/Menu/Lemon Tea.png', 1, 80),
(22, 5, 'Air Mineral', 'air-mineral', 'Air mineral botol segar dan higienis.', 4000, 'img/Menu/Air Mineral.png', 1, 100);
