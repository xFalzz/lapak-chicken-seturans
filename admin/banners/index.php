...
<section class="content-with-sidebar">
    ...
    <div class="grid grid-2">
        ...
        <div class="grid"><?php foreach ($stmt->fetchAll() as $ba): ?><article class="card"><img src="<?= e(base_url($ba['image'])) ?>" alt=""><h3><?= e($ba['title']) ?></h3><p><?= e($ba['branch_name']) ?> - <?= $ba['is_active'] ? 'Aktif' : 'Nonaktif' ?></p></article><?php endforeach; ?></div>
    </div>
</section>
